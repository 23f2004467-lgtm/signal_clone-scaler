...
| Groups with roles + admin add/remove | **Search** — client-side filter of already-fetched lists |
...
| **Cut entirely:** attachments (worst cost/value for a 24-hour budget), Redis/broadcaster, async ORM, message edit/delete, cursor-pagination machinery beyond `before_id`, mobile polish | |
